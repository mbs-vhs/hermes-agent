...
def run_conversation(
    ...
    try:
        ...
        _recent_seed_block = ""
    # MERGE (v2026.7.20): stash on the agent so the prologue's
    # compose_user_api_content stamp can include the seed too. Upstream made that
    # the single composition point; a seed visible only to conversation_loop would
    # make the persisted sidecar drift from the wire.
    agent._recent_seed_block = _recent_seed_block
