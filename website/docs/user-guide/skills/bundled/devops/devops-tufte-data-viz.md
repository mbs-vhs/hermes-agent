---
title: "Tufte Data Viz — Tufte-principled charts, dashboards, and data visualization"
sidebar_label: "Tufte Data Viz"
description: "Use when creating, reviewing, or styling charts, graphs, dashboards, sparklines, or any data visualization."
---
...
Use when creating, reviewing, or styling charts, graphs, dashboards, sparklines, or any data visualization.
...
| Path | `skills/devops/tufte-data-viz` |
| Version | `1.0.0` |
| Author | Caylent + Hermes Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `data-visualization`, `charts`, `tufte`, `accessibility`, `responsive`, `dashboards` |
