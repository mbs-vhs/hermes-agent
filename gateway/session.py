    ...
    def _get_or_create_session_impl(
        ...
        with self._lock:
            ...
            if session_key in self._entries and not force_new:
                ...
                # The fork's redundant re-defaulting of was_auto_reset /
                # auto_reset_reason / reset_had_activity was RETIRED here: all
                # three are already initialized at the top of Phase 2 above, so
